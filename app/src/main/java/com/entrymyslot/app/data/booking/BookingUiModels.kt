...
data class ShowtimeDto(val id: Int, val movieId: Int, val cinemaId: Int, val screenId: Int, val showDatetime: String, val endDatetime: String, val language: String, val format: String, val price: Int, val currency: String = "INR", val totalSeats: Int, val availableSeats: Int, val bookedSeats: Int = 0, val status: String, val screenName: String = "")
...
data class AuthoritativeBillDto(
    ...
    val taxableAmountPaise: Int? = null, val cgstPaise: Int? = null, val sgstPaise: Int? = null, val gstTotalPaise: Int? = null,
    val platformFeePaise: Int? = null, val totalPaise: Int? = null, val currency: String, val calculatedAt: String = ""
)
